...
export default function PartnerAdminGuide({ mode, partnerId, partnerName, headline, description, sectionsCount, fieldsCount, reportEnabled, }: PartnerAdminGuideProps) {
    ...
    return (<div className="rounded-lg border border-border bg-muted/20 p-4 space-y-2">
        ...
        <AccordionItem value="what-changes">
          ...
          <AccordionContent>
            <ul className="list-disc pl-5 space-y-1 text-xs text-muted-foreground">
              ...
              <li>
                Report toggle controls whether the report search flow is enabled
                for this partner.
              </li>
            </ul>
          </AccordionContent>
          ...
          <AccordionContent>
            <div className="rounded-md border border-border bg-background p-3 space-y-2">
              ...
              <div className="text-xs text-muted-foreground">
                Sections: {sectionsCount} | Fields: {fieldsCount} | Report:{" "}
              ...
              {hasPreviewPath ? (<Link href={`/${cleanPartnerId}`} target="_blank" rel="noreferrer" className="text-xs font-medium underline underline-offset-4">
