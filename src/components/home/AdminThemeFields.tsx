...
export default function AdminThemeFields({ previewPartnerName, previewHeadline, previewDescription, themePrimary, themePrimaryForeground, themeRadius, themePageBackground, themeHeaderBackground, themeFooterBackground, themeCardBackground, themeCardBorder, themeHeadlineColor, themeDescriptionColor, themeBodyTextColor, themeBadgeStyle, radixAccentColor, radixGrayColor, radixRadius, radixScaling, radixPanelBackground, radixAppearance, onThemePrimaryChange, onThemePrimaryForegroundChange, onThemeRadiusChange, onThemePageBackgroundChange, onThemeHeaderBackgroundChange, onThemeFooterBackgroundChange, onThemeCardBackgroundChange, onThemeCardBorderChange, onThemeHeadlineColorChange, onThemeDescriptionColorChange, onThemeBodyTextColorChange, onThemeBadgeStyleChange, onRadixAccentColorChange, onRadixGrayColorChange, onRadixRadiusChange, onRadixScalingChange, onRadixPanelBackgroundChange, onRadixAppearanceChange, }: AdminThemeFieldsProps) {
    ...
    const displayDescription = previewDescription?.trim() ||
    ...
    return (<>
        ...
        <div className="px-3 py-2 bg-muted/40 border-t border-border">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1">
            ...
            string
                ...
                <span className="w-3 h-3 rounded-sm border border-border/60 flex-shrink-0" style={{ background: color }}/>
      ...
      <div className="md:col-span-2 rounded-lg border border-border bg-muted/20 p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <HslColorField id="themePrimary" label="Primary Color" value={themePrimary} placeholder="210 100% 35%" fallbackHex="#1d4ed8" onChange={onThemePrimaryChange}/>
            <p className="text-[11px] text-muted-foreground">
              Buttons, brand badge background, interactive highlights.
            </p>
          </div>
          <div className="space-y-1">
            <HslColorField id="themePrimaryForeground" label="Primary Foreground" value={themePrimaryForeground} placeholder="0 0% 100%" fallbackHex="#ffffff" onChange={onThemePrimaryForegroundChange}/>
            <p className="text-[11px] text-muted-foreground">
      ...
      <div className="space-y-1">
        ...
        <Input id="themeRadius" value={themeRadius} onChange={(e) => onThemeRadiusChange(e.target.value)} placeholder="8px"/>
        <p className="text-[11px] text-muted-foreground">
      ...
      <div className="space-y-1">
        ...
        <select id="themeBadgeStyle" value={themeBadgeStyle} onChange={(e) => onThemeBadgeStyleChange(e.target.value as "soft" | "solid")} className={selectClass}>
        ...
        <p className="text-[11px] text-muted-foreground">
          Affects the Report chip in the header and status badges.
        </p>
      </div>
      ...
      <details className="md:col-span-2 rounded-lg border border-border bg-muted/20 p-4">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <ColorField id="themePageBackground" label="Page Background" value={themePageBackground} placeholder="#f8fafc" fallbackHex="#f8fafc" onChange={onThemePageBackgroundChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
              The full-page canvas visible behind all content.
            </p>
          </div>
          <div className="space-y-1">
            <ColorField id="themeHeaderBackground" label="Header Background" value={themeHeaderBackground} placeholder="#ffffff" fallbackHex="#ffffff" onChange={onThemeHeaderBackgroundChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
              Top navigation bar with the brand badge and partner name.
            </p>
          </div>
          <div className="space-y-1">
            <ColorField id="themeCardBackground" label="Form Card Background" value={themeCardBackground} placeholder="#ffffff" fallbackHex="#ffffff" onChange={onThemeCardBackgroundChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
              The surface of the form container card.
            </p>
          </div>
          <div className="space-y-1">
            <ColorField id="themeCardBorder" label="Card Border Color" value={themeCardBorder} placeholder="rgba(15,23,42,0.1)" fallbackHex="#0f172a" onChange={onThemeCardBorderChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
              Border used on the form card, dividers, and input outlines.
            </p>
          </div>
          <div className="space-y-1">
            <ColorField id="themeFooterBackground" label="Footer Background" value={themeFooterBackground} placeholder="#ffffff" fallbackHex="#ffffff" onChange={onThemeFooterBackgroundChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
      ...
      <details className="md:col-span-2 rounded-lg border border-border bg-muted/20 p-4">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <ColorField id="themeHeadlineColor" label="Headline Color" value={themeHeadlineColor} placeholder="#0f172a" fallbackHex="#0f172a" onChange={onThemeHeadlineColorChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
              Large page title (e.g. "Contact Acme Corp").
            </p>
          </div>
          <div className="space-y-1">
            <ColorField id="themeDescriptionColor" label="Description Color" value={themeDescriptionColor} placeholder="#475569" fallbackHex="#475569" onChange={onThemeDescriptionColorChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
              Subtitle text, helper copy, and muted labels.
            </p>
          </div>
          <div className="space-y-1">
            <ColorField id="themeBodyTextColor" label="Body Text Color" value={themeBodyTextColor} placeholder="#0f172a" fallbackHex="#0f172a" onChange={onThemeBodyTextColorChange} colSpan2={false}/>
            <p className="text-[11px] text-muted-foreground">
      ...
      <details className="md:col-span-2 rounded-lg border border-border bg-muted/20 p-4">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <select id="radixAccentColor" value={radixAccentColor} onChange={(e) => onRadixAccentColorChange(e.target.value)} className={selectClass}>
          ...
          <div className="space-y-2">
            ...
            <select id="radixGrayColor" value={radixGrayColor} onChange={(e) => onRadixGrayColorChange(e.target.value)} className={selectClass}>
          ...
          <div className="space-y-2">
            ...
            <select id="radixRadius" value={radixRadius} onChange={(e) => onRadixRadiusChange(e.target.value)} className={selectClass}>
          ...
          <div className="space-y-2">
            ...
            <select id="radixScaling" value={radixScaling} onChange={(e) => onRadixScalingChange(e.target.value)} className={selectClass}>
          ...
          <div className="space-y-2">
            ...
            <select id="radixPanelBackground" value={radixPanelBackground} onChange={(e) => onRadixPanelBackgroundChange(e.target.value)} className={selectClass}>
          ...
          <div className="space-y-2">
            ...
            <select id="radixAppearance" value={radixAppearance} onChange={(e) => onRadixAppearanceChange(e.target.value)} className={selectClass}>
