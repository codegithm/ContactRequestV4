...
export const contactRequestFieldOptions: ContactRequestFieldOption[] = contactRequestModelFieldIds.map((fieldId) => {
...
export function getGroupedAvailableContactRequestFields(usedFieldIds: string[]) {
...
export function createEditableFieldFromCatalog(fieldId: string, section: EditablePartnerSection): EditablePartnerField | null {
...
export function flattenPartnerFields(config: PartnerConfig): EditablePartnerField[] {
...
export function updatePartnerFields(config: PartnerConfig, editableFields: EditablePartnerField[]): PartnerConfig {
    const sectionSeed = config.sections
        ...
        : config.fields.length > 0
            ...
            : [];
    const sectionMap = new Map(sectionSeed.map((section) => [section.id, section]));
