...
@media (pointer: coarse) {
  .rt-Card:where(:any-link, button, label):where(:active:not(:-webkit-any(:focus-visible, [data-state="open"]))):before {
    background-image: linear-gradient(var(--gray-a4), var(--gray-a4));
  }

  .rt-Card:where(:-moz-any-link, button, label):where(:active:not(:-moz-any(:focus-visible, [data-state="open"]))):before {
    background-image: linear-gradient(var(--gray-a4), var(--gray-a4));
  }
...
@media (hover: hover) {
  .rt-Kbd:where(.rt-variant-classic):where(:-moz-any-link, button):where(:hover) {
    background-color: var(--color-background);
    box-shadow: var(--kbd-box-shadow), 0 0 0 .05em var(--gray-a5);
    transition-duration: 40ms, 40ms;
  }

  .rt-Kbd:where(.rt-variant-classic):where(:-webkit-any-link, button):where(:hover) {
    background-color: var(--color-background);
    box-shadow: var(--kbd-box-shadow), 0 0 0 .05em var(--gray-a5);
    transition-duration: 40ms, 40ms;
  }
...
.rt-Kbd:where(.rt-variant-classic):where(:-moz-any-link, button):where([data-state="open"]) {
  background-color: var(--color-background);
  box-shadow: var(--kbd-box-shadow), 0 0 0 .05em var(--gray-a5);
  transition-duration: 40ms, 40ms;
}

.rt-Kbd:where(.rt-variant-classic):where(:-webkit-any-link, button):where([data-state="open"]) {
  background-color: var(--color-background);
  box-shadow: var(--kbd-box-shadow), 0 0 0 .05em var(--gray-a5);
  transition-duration: 40ms, 40ms;
}
...
.rt-Kbd:where(.rt-variant-classic):where(:-moz-any-link, button):where(:active:not([data-state="open"])) {
  background-color: var(--gray-2);
...
.rt-Kbd:where(.rt-variant-classic):where(:-webkit-any-link, button):where(:active:not([data-state="open"])) {
  background-color: var(--gray-2);
  box-shadow: inset 0 .05em var(--black-a3), 0 0 0 .05em var(--gray-a7);
  padding-top: .05em;
  padding-bottom: 0;
...
.rt-Kbd:where(.rt-variant-classic):where(:-moz-any-link, button):where(:focus-visible) {
  outline: 2px solid var(--focus-8);
}

.rt-Kbd:where(.rt-variant-classic):where(:-webkit-any-link, button):where(:focus-visible) {
  outline: 2px solid var(--focus-8);
}
...
@media (hover: hover) {
  .rt-Kbd:where(.rt-variant-soft):where(:-moz-any-link, button):where(:hover) {
    background-color: var(--gray-a4);
  }

  .rt-Kbd:where(.rt-variant-soft):where(:-webkit-any-link, button):where(:hover) {
    background-color: var(--gray-a4);
  }
...
.rt-Kbd:where(.rt-variant-soft):where(:-moz-any-link, button):where([data-state="open"]) {
  background-color: var(--gray-a4);
}

.rt-Kbd:where(.rt-variant-soft):where(:-webkit-any-link, button):where([data-state="open"]) {
  background-color: var(--gray-a4);
}
...
.rt-Kbd:where(.rt-variant-soft):where(:-moz-any-link, button):where(:active:not([data-state="open"])) {
  background-color: var(--gray-a5);
}

.rt-Kbd:where(.rt-variant-soft):where(:-webkit-any-link, button):where(:active:not([data-state="open"])) {
  background-color: var(--gray-a5);
}
...
.rt-Kbd:where(.rt-variant-soft):where(:-moz-any-link, button):where(:focus-visible) {
  outline: 2px solid var(--focus-8);
}

.rt-Kbd:where(.rt-variant-soft):where(:-webkit-any-link, button):where(:focus-visible) {
  outline: 2px solid var(--focus-8);
}
...
@media (pointer: coarse) {
  .rt-Link:where(:any-link, button):where(:active:not(:-webkit-any(:focus-visible, [data-state="open"]))) {
    outline: .75em solid var(--accent-a4);
    outline-offset: -.6em;
  }

  .rt-Link:where(:-moz-any-link, button):where(:active:not(:-moz-any(:focus-visible, [data-state="open"]))) {
    outline: .75em solid var(--accent-a4);
    outline-offset: -.6em;
  }
...
:where([data-accent-color]:not(:-webkit-any(.radix-themes, .rt-high-contrast))) .rt-Link:where(:any-link, button):where(.rt-underline-auto):where([data-accent-color=""]) {
  -webkit-text-decoration-line: underline;
  text-decoration-line: underline;
  -webkit-text-decoration-color: var(--accent-a6);
  text-decoration-color: var(--accent-a6);
...
:where([data-accent-color]:not(:-moz-any(.radix-themes, .rt-high-contrast))) .rt-Link:where(:-moz-any-link, button):where(.rt-underline-auto):where([data-accent-color=""]) {
  -webkit-text-decoration-line: underline;
  text-decoration-line: underline;
  -webkit-text-decoration-color: var(--accent-a6);
  text-decoration-color: var(--accent-a6);
