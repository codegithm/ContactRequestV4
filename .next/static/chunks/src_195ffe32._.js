...
"[project]/src/components/loading-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoadingProvider(param) {
    ...
    const [apiLoading, setApiLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [manualNavigating, setManualNavigating] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
...
_s(LoadingProvider, "31ZO+Tyi2Tkt6/4wzipYXutli0Y=", false, function() {
    return [
...
function NavigationLoader() {
    ...
    const { setNavigating } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$loading$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoading"])();
    const timeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const updateRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavigationLoader.useEffect": ()=>{
            const startNavigation = {
                "NavigationLoader.useEffect.startNavigation": ()=>{
                    ...
                    }["NavigationLoader.useEffect.startNavigation"], 8000);
                }
            }["NavigationLoader.useEffect.startNavigation"];
            const clickHandler = {
                "NavigationLoader.useEffect.clickHandler": (event)=>{
                    ...
                    var _anchor_getAttribute;
                    const href = (_anchor_getAttribute = anchor.getAttribute("href")) !== null && _anchor_getAttribute !== void 0 ? _anchor_getAttribute : "";
                    if (!href) return;
            ...
            }["NavigationLoader.useEffect.clickHandler"];
            const originalPushState = window.history.pushState;
            const originalReplaceState = window.history.replaceState;
            window.history.pushState = ({
                "NavigationLoader.useEffect": function() {
            ...
            const popStateHandler = {
                "NavigationLoader.useEffect.popStateHandler": ()=>{
                    startNavigation();
                }
            }["NavigationLoader.useEffect.popStateHandler"];
...
_s(NavigationLoader, "bhtuwxEwR9ArawqeVjxxxhJFGRI=", false, function() {
    return [
...
"[project]/src/components/progress-bar.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProgressBar() {
    _s();
    const { isNavigating, isApiLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$loading$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoading"])();
        ...
        "ProgressBar.useEffect": ()=>{
            if (isLoading) {
                ...
                const interval = setInterval({
                    "ProgressBar.useEffect.interval": ()=>{
                        setProgress({
                            "ProgressBar.useEffect.interval": (prev)=>{
                                if (prev >= 90) return 90;
                                return prev + Math.random() * 30;
                            }
                        }["ProgressBar.useEffect.interval"]);
                    }
                }["ProgressBar.useEffect.interval"], 200);
                return ({
                    "ProgressBar.useEffect": ()=>clearInterval(interval)
                })["ProgressBar.useEffect"];
            } else {
                // Complete the progress bar
                setProgress(100);
                const timeout = setTimeout({
                    "ProgressBar.useEffect.timeout": ()=>{
                        setHidden(true);
                        setProgress(0);
                    }
                }["ProgressBar.useEffect.timeout"], 300);
                return ({
                    "ProgressBar.useEffect": ()=>clearTimeout(timeout)
                })["ProgressBar.useEffect"];
            }
        }
    }["ProgressBar.useEffect"], [
...
_s(ProgressBar, "bKahGFu2uM1r23JINHrPdNGMPOo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$loading$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoading"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$progress$2d$bar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/progress-bar.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Providers(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        client: queryClient,
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$loading$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipProvider"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$progress$2d$bar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProgressBar"], {}, void 0, false, {
                        fileName: "[project]/src/components/providers.tsx",
                        lineNumber: 22,
                        columnNumber: 11
                    }, this),
...
//# sourceMappingURL=src_195ffe32._.js.map